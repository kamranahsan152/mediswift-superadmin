...
export const VendorDetail = ({ vendorId }: any) => {
  const mdUp = useMediaQuery((theme: Theme) => theme.breakpoints.up("md"));
  const align = mdUp ? "horizontal" : "vertical";

  const { isLoading, data } = useGetUserByIdQuery({ id: vendorId });
        ...
        <>
          <Box display={"flex"}>
            ...
            >
              ...
              <Divider />
              <PropertyList>
                <PropertyListItem align={align} label="Vendor Name">
                  <Skeleton variant="text" width={"80%"} />
                </PropertyListItem>
                <Divider />
            ...
            <PropertyList>
              ...
              <PropertyListItem align={align} label="ShopID">
                {data.data?.shops?.length === 0 ? (
                  ...
                  <Chip size="small" label={data.data?.shops[0]} />
                )}
              </PropertyListItem>
              <Divider />
              {data.data?.shops?.length === 0 ? null : (
